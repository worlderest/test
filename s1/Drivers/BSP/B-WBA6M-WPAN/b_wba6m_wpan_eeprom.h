/**
  ******************************************************************************
  * @file    b_wba6m_wpan_eeprom.h
  * @author  MCD Application Team
  * @brief   This file contains all the functions prototypes for
  *          the b_wba6m_wpan_eeprom.c firmware driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef B_WBA6M_WPAN_EEPROM_H
#define B_WBA6M_WPAN_EEPROM_H
...
/** @addtogroup B_WBA6M_WPAN_EEPROM
  * @brief This file includes the I2C EEPROM driver of B_WBA6M_WPAN board.
  * @{
  */

/** @defgroup B_WBA6M_WPAN_EEPROM_Exported_Types B_WBA6M_WPAN EEPROM Exported Types
  * @{
  */
/**
  * @}
...
/** @defgroup B_WBA6M_WPAN_EEPROM_Exported_Constants B_WBA6M_WPAN EEPROM Exported Constants
  * @{
  */
...
/**
  * @}
  */
/** @addtogroup B_WBA6M_WPAN_EEPROM_Exported_Variables B_WBA6M_WPAN EEPROM Exported Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_EEPROM_Exported_FunctionsPrototypes B_WBA6M_WPAN EEPROM Exported Functions Prototypes
  * @{
  */
