/**
  ******************************************************************************
  * @file    b_wba6m_wpan_eeprom.c
  * @author  MCD Application Team
  * @brief   This file provides a set of functions needed to manage an I2C M24256
  *          EEPROM memory mounted on the B_WBA6M_WPAN board(MB1551).
  ******************************************************************************
  * @attention
  *
  ...
  *           GPIO) are defined in b_wba6m_wpan_bus.h file, and the initialization is
  ...
  *                 an EEPROM instance. On the B_WBA6M_WPAN board, there's one instance. Therefore,
  *                 this parameter should be 0.
  * @endverbatim
  ******************************************************************************
  */
/* Includes ------------------------------------------------------------------*/
#include "b_wba6m_wpan_eeprom.h"
...
/** @defgroup B_WBA6M_WPAN_EEPROM B_WBA6M_WPAN EEPROM
  * @{
  */

/** @defgroup B_WBA6M_WPAN_EEPROM_Exported_Variables B_WBA6M_WPAN EEPROM Exported Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_EEPROM_Private_Variables B_WBA6M_WPAN EEPROM Private Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_EEPROM_Private_Function_Prototypes B_WBA6M_WPAN EEPROM Private Functions Prototypes
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_EEPROM_Exported_Functions B_WBA6M_WPAN EEPROM Exported Functions
  * @{
  */
/**
...
/** @defgroup B_WBA6M_WPAN_EEPROM_Private_Functions B_WBA6M_WPAN EEPROM Private Functions
  * @{
  */
/**
...
static int32_t M24256_Probe(void)
{
  ...
  IOCtx.Init        = B_WBA6M_WPAN_I2C_Init;
  IOCtx.DeInit      = B_WBA6M_WPAN_I2C_DeInit;
  IOCtx.Read        = B_WBA6M_WPAN_I2C_ReadReg16;
  IOCtx.Write       = B_WBA6M_WPAN_I2C_WriteReg16;
  IOCtx.IsReady     = B_WBA6M_WPAN_I2C_IsReady;
