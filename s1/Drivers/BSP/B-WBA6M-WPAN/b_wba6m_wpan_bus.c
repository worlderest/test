...
/** @defgroup B_WBA6M_WPAN_BUS B_WBA6M_WPAN BUS
  * @{
  */

/** @defgroup B_WBA6M_WPAN_BUS_Private_Defines B_WBA6M_WPAN BUS Private Defines
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Private_Types B_WBA6M_WPAN BUS Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup B_WBA6M_WPAN_BUS_Private_Constants B_WBA6M_WPAN BUS Private Constants
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Private_Variables B_WBA6M_WPAN BUS Private Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Exported_Variables B_WBA6M_WPAN BUS Exported Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Private_Function_Prototypes B_WBA6M_WPAN BUS Private Function Prototypes
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Exported_Functions B_WBA6M_WPAN BUS Exported Functions
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Private_Functions B_WBA6M_WPAN BUS Private Functions
  * @{
  */
...
static void I2C3_MspInit(I2C_HandleTypeDef *hI2c)
{
  ...
  /*** Configure the GPIOs ***/
  /* Enable GPIO clock */
  BUS_I2C3_GPIO_SCL_CLK_ENABLE();
  BUS_I2C3_GPIO_SDA_CLK_ENABLE();
