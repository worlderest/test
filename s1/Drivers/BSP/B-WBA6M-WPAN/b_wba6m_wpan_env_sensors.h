/**
  ******************************************************************************
  * @file    b_wba6m_wpan_env_sensors.h
...
#ifndef B_WBA6M_WPAN_ENV_SENSORS_H
#define B_WBA6M_WPAN_ENV_SENSORS_H
...
/** @addtogroup B_WBA6M_WPAN_ENV_SENSORS B_WBA6M_WPAN ENV SENSORS
  * @{
  */

/** @defgroup B_WBA6M_WPAN_ENV_SENSORS_Exported_Types B_WBA6M_WPAN ENV SENSORS Exported Types
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSOR_Exported_Constants B_WBA6M_WPAN ENV SENSOR Exported Constants
  * @{
  */
...
/** @addtogroup B_WBA6M_WPAN_ENV_SENSORS_Exported_Functions B_WBA6M_WPAN ENV SENSOR Exported Functions
  * @{
  */
...
#endif /* B_WBA6M_WPAN_ENV_SENSORS_H */
