/**
  ******************************************************************************
  * @file    b_wba6m_wpan_env_sensors.c
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSORS B_WBA6M_WPAN ENV SENSORS
  * @{
  */

/** @defgroup B_WBA6M_WPAN_ENV_SENSORS_Exported_Variables B_WBA6M_WPAN ENV SENSORS Exported Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSORS_Private_Variables B_WBA6M_WPAN ENV SENSORS Private Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSORS_Private_Function_Prototypes B_WBA6M_WPAN ENV SENSORS Private Function Prototypes
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSORS_Exported_Functions B_WBA6M_WPAN ENV SENSOR Exported Functions
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSORS_Private_Functions B_WBA6M_WPAN ENV SENSORS Private Functions
  * @{
  */
...
static int32_t SHT40AD1B_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.Read        = B_WBA6M_WPAN_I2C_Read;
  io_ctx.Write       = B_WBA6M_WPAN_I2C_Write;
