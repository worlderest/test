/**
  ******************************************************************************
  * @file    b_wba6m_wpan_env_sensors_ex.c
...
/* Includes ------------------------------------------------------------------*/
#include "b_wba6m_wpan_env_sensors_ex.h"
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSOR_EX B_WBA6M_WPAN ENV SENSOR EX
  * @{
  */

/** @defgroup B_WBA6M_WPAN_ENV_SENSOR_EX_Imported_Variables B_WBA6M_WPAN ENV SENSOR EX Imported Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_ENV_SENSOR_EX_Exported_Functions B_WBA6M_WPAN ENV SENSOR EX Exported Functions
  * @{
  */
