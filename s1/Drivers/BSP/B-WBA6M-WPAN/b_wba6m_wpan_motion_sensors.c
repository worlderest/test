/**
  ******************************************************************************
  * @file    b_wba6m_wpan_motion_sensors.c
  * @author  MCD Application Team
  * @brief   This file provides a set of functions needed to manage the
  *          motion sensors mounted on the B_WBA6M_WPAN board (MB2131).
  ******************************************************************************
  * @attention
  *
...
/** @addtogroup B_WBA6M_WPAN B_WBA6M_WPAN
  * @{
  */

/** @defgroup B_WBA6M_WPAN_MOTION_SENSORS B_WBA6M_WPAN MOTION SENSORS
  * @{
  */

/** @defgroup B_WBA6M_WPAN_MOTION_SENSOR_Exported_Variables B_WBA6M_WPAN MOTION SENSORS Exported Variables
  * @{
  */
extern void
...
/** @defgroup B_WBA6M_WPAN_MOTION_SENSOR_Private_Variables B_WBA6M_WPAN MOTION SENSORS Private Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_MOTION_SENSOR_Private_Function_Prototypes B_WBA6M_WPAN MOTION SENSORS Private Function Prototypes
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_MOTION_SENSOR_Exported_Functions B_WBA6M_WPAN MOTION SENSORS Exported Functions
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_MOTION_SENSOR_Private_Functions B_WBA6M_WPAN MOTION SENSORS Private Functions
  * @{
  */
...
static int32_t ISM330DHCX_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.Init        = B_WBA6M_WPAN_I2C_Init;
  io_ctx.DeInit      = B_WBA6M_WPAN_I2C_DeInit;
  io_ctx.ReadReg     = B_WBA6M_WPAN_I2C_ReadReg;
  io_ctx.WriteReg    = B_WBA6M_WPAN_I2C_WriteReg;
  io_ctx.GetTick     = B_WBA6M_WPAN_GetTick;
