/**
  ******************************************************************************
  * @file    b_wba6m_wpan_bus.h
  * @author  MCD Application Team
  * @brief   This file contains definitions for B_WBA6M_WPAN bus.
  ******************************************************************************
  * @attention
  *
...
#ifndef B_WBA6M_WPAN_BUS_H
#define B_WBA6M_WPAN_BUS_H
...
/** @addtogroup B_WBA6M_WPAN_BUS
  * @{
  */

/** @defgroup B_WBA6M_WPAN_BUS_Exported_Types B_WBA6M_WPAN BUS Exported Types
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_BUS_Exported_Constants B_WBA6M_WPAN BUS Exported Constants
  * @{
  */
...
#define BUS_I2C3_GPIO_SCL_CLK_ENABLE()  __HAL_RCC_GPIOA_CLK_ENABLE()
#define BUS_I2C3_GPIO_SDA_CLK_ENABLE()  __HAL_RCC_GPIOC_CLK_ENABLE()
...
/** @addtogroup B_WBA6M_WPAN_BUS_Exported_Variables
  * @{
  */
...
/** @addtogroup B_WBA6M_WPAN_BUS_Exported_Functions
  * @{
  */
