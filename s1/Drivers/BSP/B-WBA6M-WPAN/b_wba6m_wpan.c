...
/** @defgroup B_WBA6M_WPAN B_WBA6M_WPAN
  * @{
  */

/** @defgroup B_WBA6M_WPAN_COMMON B_WBA6M_WPAN COMMON
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on B-WBA6M-WPAN Kit from STMicroelectronics.
  * @{
  */

/** @defgroup B_WBA6M_WPAN_COMMON_Private_Defines B_WBA6M_WPAN COMMON Private Defines
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_COMMON_Private_TypesDefinitions B_WBA6M_WPAN COMMON Private Types Definitions
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_COMMON_Private_FunctionPrototypes B_WBA6M_WPAN COMMON Private Function Prototypes
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_COMMON_Exported_Variables B_WBA6M_WPAN COMMON Exported Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @defgroup B_WBA6M_WPAN_COMMON_Private_Variables B_WBA6M_WPAN COMMON Private Variables
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_COMMON_Exported_Functions B_WBA6M_WPAN COMMON Exported Functions
  * @{
  */

/**
  * @brief  This method returns the B-WBA6M-WPAN BSP Driver revision.
  * @retval version : 0xXYZR (8bits for each decimal, R for RC).
  */
int32_t BSP_GetVersion(void)
{
  return ((int32_t)B_WBA6M_WPAN_BSP_VERSION);
}
...
{
  return (const uint8_t*)B_WBA6M_WPAN_BSP_BOARD_NAME;
}
...
{
  return (const uint8_t*)B_WBA6M_WPAN_BSP_BOARD_ID;
}

/** @defgroup B_WBA6M_WPAN_COMMON_LED_Functions B_WBA6M_WPAN COMMON LED Functions
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_COMMON_BUTTON_Functions B_WBA6M_WPAN_COMMON BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup B_WBA6M_WPAN_COMMON_COM_Functions B_WBA6M_WPAN COMMON COM Functions
  * @{
  */
...
/** @defgroup B_WBA6M_WPAN_COMMON_Private_Functions B_WBA6M_WPAN COMMON Private Functions
  * @{
  */
